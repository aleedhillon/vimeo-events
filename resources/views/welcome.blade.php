...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            @else
            <a href="{{ route('login') }}" class="text-sm text-gray-700 underline">User Log in</a>

            @if (Route::has('register'))
            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 underline">User Register</a>
            @endif

            <a href="{{ route('participant.login') }}" class="text-sm text-gray-700 underline">Paricipant Login</a>

            @if (Route::has('participant.register'))
            <a href="{{ route('participant.register') }}" class="ml-4 text-sm text-gray-700 underline">Participant
                Register</a>
            @endif
            @endauth
        </div>
